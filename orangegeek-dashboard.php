...
function og_options(){
    ...
    ?>
        ...
        <iframe title="Feedback Form" class="freshwidget-embedded-form" id="freshwidget-embedded-form" src="https://support.orangegeek.com/widgets/feedback_widget/new?&widgetType=embedded&formTitle=Create+a+Ticket+&submitTitle=Submit+Ticket&submitThanks=Thank+you+for+submitting+a+ticket+to+Orange+Geek.&screenshot=No" scrolling="no" height="100%" width="90%" frameborder="0" ></iframe>
